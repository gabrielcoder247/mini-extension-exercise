...
export const Data: React.FC<{ logout(): void }> = ({ logout }) => {
  ...
  return (
    <div className="flex h-screen w-screen flex-col items-start gap-3 px-10 py-6" style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", marginTop: "100px"}}>
      ...
      <div className="flex w-full shrink-0 grow flex-col flex-wrap items-center justify-center gap-8" style={{border: "solid 1px", padding: "10px"}}>
        {classes?.map((item) => (
